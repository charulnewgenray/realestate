...
--
-- Host: localhost
-- Generation Time: Mar 27, 2015 at 06:58 AM
...
--
-- Dumping data for table `application_pdfs`
--

INSERT INTO `application_pdfs` (`id`, `user_id`, `application_no`, `path`, `created_at`, `updated_at`) VALUES
(1, 24, 1, 'application_1_1427464128.pdf', '2015-03-27 13:48:48', '2015-03-27 13:48:48');
...
(2, 'aut_bank_name', 'text', 'Bank Name', 1, 0),
(3, 'aut_balance', 'text', 'Balance', 1, 0);
...
(2, 'che_bank_name', 'text', 'Bank Name', 1, 0),
(3, 'che_balance', 'text', 'Balance', 1, 0);
...
(2, 'cre_bank_name', 'text', 'Bank Name', 1, 0),
(3, 'cre_balance', 'text', 'Balance', 1, 0);
...
(1, 5, 'newgen', '', '', '', '', '', '', ''),
(2, 5, 'newgen', '', '', '', '', '', '', ''),
(3, 1, 'hjg', 'jhg', 'hj', 'gjh', 'gj', 'gh', 'hj', 'hj'),
(4, 4, 'newgen', '', '', '', '', '', '', '');
...
(2, 'cur_emp_company', 'text', 'Company', 1, 0),
(3, 'cur_emp_address', 'text', 'Address', 1, 0),
(4, 'cur_emp_phone_no', 'text', 'Phone No', 1, 0),
(5, 'cur_emp_occupation', 'text', 'Occupation', 1, 0),
(6, 'cur_emp_supervisor', 'text', 'Supervisor', 1, 0),
(7, 'cur_emp_gross_pay', 'text', 'Gross Pay', 1, 0),
(8, 'cur_emp_employment_from', 'text', 'Employment From', 1, 0),
(9, 'cur_emp_employment_to', 'text', 'Employment To', 1, 0);
...
(1, 5, '', 'up ciur', '', '', '', '', '', '', '', '', '', '', ''),
(2, 5, '', 'up ciur', '', '', '', '', '', '', '', '', '', '', ''),
(3, 1, 'noida', 'up', 'noida', '500', 'charul', '8512815431', 'no reason', '400', '30', 'yes', 'no', '29/07/2014', '29/07/2015'),
(4, 4, '', 'up ciur', '', '', '', '', '', '', '', '', '', '', '');
...
(2, 'cur_address', 'text', 'Address', 1, 0),
(3, 'cur_state', 'text', 'State', 1, 0),
(4, 'cur_city', 'text', 'City', 1, 0),
(5, 'cur_last_amount_paid', 'text', 'Last Amount Paid', 1, 0),
(6, 'cur_owner', 'text', 'Owner', 1, 0),
(7, 'cur_phone_no', 'text', 'Phone No', 1, 0),
(8, 'cur_reason_for_leaving', 'text', 'Reason For Leaving', 1, 0),
(9, 'cur_rent_paid_full', 'text', 'Rent Paid Full', 1, 0),
(10, 'cur_give_notice', 'text', 'Give Notice', 1, 0),
(11, 'cur_asked_to_move', 'text', 'Asked To Move', 1, 0),
(12, 'cur_utilities', 'text', 'Utilities', 1, 0),
(13, 'cur_residence_from', 'text', 'Residence From', 1, 0),
(14, 'cur_residence_to', 'text', 'Residence To', 1, 0);
...
(2, 'doc_name', 'text', 'Name', 1, 0),
(3, 'doc_address', 'text', 'Address', 1, 0),
(4, 'doc_city', 'text', 'City', 1, 0),
(5, 'doc_state', 'text', 'State', 1, 0),
(6, 'doc_zip_code', 'text', 'Zip Code', 1, 0),
(7, 'doc_contact_no', 'text', 'Contact No', 1, 0);
...
(1, 5, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, 1, 'jhg', 'jh', 'gjh', 'gjh', 'gj', 'hg', 'jhg', 'jhg', 'jh', 'jh', 'gjh', 'gjh', 'gjh', 'dfdfd', 'jhg', 'hj', 'gjh'),
(3, 4, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
(2, 'question_1', 'text', 'Have you ever served a late rent notice?', 1, 0),
(3, 'question_2', 'text', 'Do any of the people who would be living in the apartment smoke?', 1, 0),
(4, 'question_3', 'text', 'How long do you think you would be txt from us ?', 1, 0),
(5, 'question_4', 'text', 'Have you ever filed for bankruptcy if so when?', 1, 0),
(6, 'question_5', 'text', 'When you would be able to move in ?', 1, 0),
(7, 'question_6', 'text', 'Have you ever been convicted txt ?', 1, 0),
(8, 'question_7', 'text', 'Have you ever been served txt notice if so when ?', 1, 0),
(9, 'question_8', 'text', 'How many pets do you have(list, type,breed, approx weight& age) ?', 1, 0),
(10, 'question_9', 'text', 'Have you had any recurring problem with your current apartment or landlord if yes please explain:', 1, 0),
(11, 'question_10', 'text', 'Why are you moving fom current address?', 1, 0),
(12, 'question_11', 'text', 'List any verifiable source and amount of income you txt to have considered.', 1, 0),
(13, 'question_12', 'text', 'If you were late financial difficulties in the future and coud''t come up with the messy to pay rent, do you know someone would loan you the money? If so provide the person''s name address and phone # so that we can use them as a reference for you.', 1, 0),
(14, 'question_13', 'text', 'Have you been a party to lawsuits in the past ? if you please explain Why ??', 1, 0),
(15, 'question_14', 'text', 'We may run a credit check and criminal background check , is there anything negative we will find that you want comment on ? ?', 1, 0),
(16, 'question_15', 'text', 'How did you hear about this apartment ?', 1, 0),
(17, 'question_16', 'text', 'Do you have email address we can reach you at?', 1, 0),
(18, 'question_17', 'text', 'Do you know anybody is looking for an apartment? please provide us their name and number,if you refer a friend and you each end up renting seperate apartment from us then we will pay you referral award.', 1, 0);
...
(2, 'law_name', 'text', 'Name', 1, 0),
(3, 'law_address', 'text', 'Address', 1, 0),
(4, 'law_city', 'text', 'City', 1, 0),
(5, 'law_state', 'text', 'State', 1, 0),
(6, 'law_zip_code', 'text', 'Zip Code', 1, 0),
(7, 'law_contact_no', 'text', 'Contact No', 1, 0);
...
(2, 'nat_name', 'text', 'Name', 1, 0),
(3, 'nat_address', 'text', 'Address', 1, 0),
(4, 'nat_city', 'text', 'City', 1, 0),
(5, 'nat_state', 'text', 'State', 1, 0),
(6, 'nat_zip_code', 'text', 'Zip Code', 1, 0),
(7, 'nat_contact_no', 'text', 'Contact No', 1, 0);
...
(2, 'occupant_name', 'text', 'Occupant Name', 1, 0),
(3, 'occupant_dob', 'text', 'Occupant Dob', 1, 0),
(4, 'occupant_relationship', 'text', 'Occupant Relationship', 1, 0);
...
(1, 5, 'charul', 'tyagi', '', '', '', '', '', '', '', ''),
(2, 1, 'charul tyagi', 'kumar', 'tyagi', 'charultyagi@newgenray.com', '29/07/1990', 'SEC123', '#1234', 'charul', '2884092', '8512815431'),
(3, 1, 'charul tyagi', 'kumar', 'tyagi', 'charultyagi@newgenray.com', '29/07/1990', 'SEC123', '#1234', 'charul', '2884092', '8512815431'),
...
(2, 'first_name', 'text', 'First Name', 1, 0),
(3, 'middle_name', 'text', 'Middle Name', 1, 0),
(4, 'last_name', 'text', 'Last Name', 1, 0),
(5, 'email', 'text', 'Email', 1, 0),
(6, 'dob', 'text', 'DOB', 1, 0),
(7, 'social_security', 'text', 'Social Security', 1, 0),
(8, 'driver_licence', 'text', 'Driver Licence', 1, 0),
(9, 'past_name', 'text', 'Past Name', 1, 0),
(10, 'home_phone', 'text', 'Home Phone', 1, 0),
(11, 'cell_phone', 'text', 'Cell Phone', 1, 0),
(27, 'message', 'text', 'Message', 0, 1),
(28, 'location', 'text', 'Location', 0, 1);
...
(229, 1, 'message', 'messa123'),
(230, 1, 'location', 'loca123');
...
(1, 5, '', '', '', '', '', '', '', ''),
(2, 1, 'gjh', 'g', 'jhg', 'jh', 'ghj', 'gjh', 'g', 'hjg'),
(3, 4, '', '', '', '', '', '', '', '');
...
(2, 'pre_emp_company', 'text', 'Company', 1, 0),
(3, 'pre_emp_address', 'text', 'Address', 1, 0),
(4, 'pre_emp_phone_no', 'text', 'Phone No', 1, 0),
(5, 'pre_emp_occupation', 'text', 'Occupation', 1, 0),
(6, 'pre_emp_supervisor', 'text', 'Supervisor', 1, 0),
(7, 'pre_emp_gross_pay', 'text', 'Gross Pay', 1, 0),
(8, 'pre_emp_employment_from', 'text', 'Employment From', 1, 0),
(9, 'pre_emp_employment_to', 'text', 'Employment To', 1, 0);
...
(1, 5, '', 'up pre', '', '', '', '', '', '', '', '', '', '', ''),
(2, 5, '', 'up pre', '', '', '', '', '', '', '', '', '', '', ''),
(3, 1, 'vxcxc', 'xcv', 'vcxc', 'xcvxc', 'xcvxc', 'xcvxc', 'xcvxvc', 'vxcv', 'cxvxc', 'jhg', 'jhg', 'hjgh', 'j'),
(4, 4, '', 'up pre', '', '', '', '', '', '', '', '', '', '', '');
...
(2, 'pre_address', 'text', 'Address', 1, 0),
(3, 'pre_state', 'text', 'State', 1, 0),
(4, 'pre_city', 'text', 'City', 1, 0),
(5, 'pre_last_amount_paid', 'text', 'Last Amount Paid', 1, 0),
(6, 'pre_owner', 'text', 'Owner', 1, 0),
(7, 'pre_phone_no', 'text', 'Phone No', 1, 0),
(8, 'pre_reason_for_leaving', 'text', 'Reason For Leaving', 1, 0),
(9, 'pre_rent_paid_full', 'text', 'Rent Paid Full', 1, 0),
(10, 'pre_give_notice', 'text', 'Give Notice', 1, 0),
(11, 'pre_asked_to_move', 'text', 'Asked To Move', 1, 0),
(12, 'pre_utilities', 'text', 'Utilities', 1, 0),
(13, 'pre_residence_from', 'text', 'Residence From', 1, 0),
(14, 'pre_residence_to', 'text', 'Residence To', 1, 0);
...
(2, 'pri_emp_company', 'text', 'Company', 1, 0),
(3, 'pri_emp_address', 'text', 'Address', 1, 0),
(4, 'pri_emp_phone_no', 'text', 'Phone No', 1, 0),
(5, 'pri_emp_occupation', 'text', 'Occupation', 1, 0),
(6, 'pri_emp_supervisor', 'text', 'Supervisor', 1, 0),
(7, 'pri_emp_gross_pay', 'text', 'Gross Pay', 1, 0),
(8, 'pri_emp_employment_from', 'text', 'Employment From', 1, 0),
(9, 'pri_emp_employment_to', 'text', 'Employment To', 1, 0);
...
(1, 5, '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, 1, 'hjg', 'hg', 'jhg', 'hj', 'g', 'hg', 'h', 'jg', 'jh', 'g', 'hj', 'jh', 'gh'),
(3, 4, '', '', '', '', '', '', '', '', '', '', '', '', '');
...
(2, 'pri_address', 'text', 'Address', 1, 0),
(3, 'pri_state', 'text', 'State', 1, 0),
(4, 'pri_city', 'text', 'City', 1, 0),
(5, 'pri_last_amount_paid', 'text', 'Last Amount Paid', 1, 0),
(6, 'pri_owner', 'text', 'Owner', 1, 0),
(7, 'pri_phone_no', 'text', 'Phone No', 1, 0),
(8, 'pri_reason_for_leaving', 'text', 'Reason For Leaving', 1, 0),
(9, 'pri_rent_paid_full', 'text', 'Rent Paid Full', 1, 0),
(10, 'pri_give_notice', 'text', 'Give Notice', 1, 0),
(11, 'pri_asked_to_move', 'text', 'Asked To Move', 1, 0),
(12, 'pri_utilities', 'text', 'Utilities', 1, 0),
(13, 'pri_residence_from', 'text', 'Residence From', 1, 0),
(14, 'pri_residence_to', 'text', 'Residence To', 1, 0);
...
(2, 'sav_bank_name', 'text', 'Bank Name', 1, 0),
(3, 'sav_balance', 'text', 'Balance', 1, 0);
...
(2, 'make', 'text', 'Make', 1, 0),
(3, 'model', 'text', 'Model', 1, 0),
(4, 'color', 'text', 'Color', 1, 0),
(5, 'year', 'text', 'Year', 1, 0),
(6, 'licence', 'text', 'Licence', 1, 0);
...
(1, 'Admin Istrator', 'admin@admin.com', '$2y$10$bDRccGozLZmsGLe291oqLuoF7chmWxvyVKEsvylRJyJLMth/TBANW', '7gVSd1dF4VGMHy1rIPyO7gcqYuVOEtHef5t4wZvavk8o5XETFBzCi8mFGYUh', '2015-03-02 04:50:10', '2015-03-27 00:33:34', 1),
...
(17, 'charul', 'charultyagi@newgenray.com', '$2y$10$hQ/LmTDBvmDqlrP/3MuepOa208iSuaDXGrzDznForo2gf7orQJNXe', 'B2qTh45adKlBwebGRtcbqtfZljUJVHqgLTJNekCO1GzgBmbiP62R1DvqrWel', '2015-03-18 00:14:35', '2015-03-27 08:19:13', 1),
